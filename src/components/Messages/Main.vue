    ...
    <div class="flex">
      ...
      <div class="w-1/4 border-r">
        ...
        <div class="overflow-y-auto h-[calc(100vh-70px)]">
          <div
            ...
            :class="{ 'bg-blue-100': selectedContact?.id === contact.id }"
          >
      ...
      <div class="flex-1 flex flex-col">
        ...
        <div class="p-4 border-t">
          <div class="flex items-center">
            <button class="p-2 hover:bg-gray-100 rounded mr-2">
            ...
            />
            <button @click="sendMessage" class="ml-2 p-2 bg-blue-500 text-white rounded hover:bg-blue-600">
